"""
Features added in V8 of haiku generator:
...
#Random to generate random syllables, choose random words and create different chances of different haikus
#cmudict is the dictionary used to check words
#nltk.corpus's tool helps to find number of syllables of a word
#inflect is used to convert both english and gibberish plural nouns to singular
#mlconjug3 is used to convert only root of verbs to indicative present

#method that will be used to find the singular of a noun
toSingular = inflect.engine() 
#conjugator imported from a module
