#up to dropping counters with animation
#before implmeneting win conditions


import tkinter,time #library to create GUI
...
def placeCounter(column): #function used to place counter given a column
    global currentPlayer, board, animations
...
#global varianles used to control flow
drop = True
animations = True
